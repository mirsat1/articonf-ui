...
function ContextProvider({ children }) {
  ...
  const defaultTicConfig = {
    ...
    services: ["{{caservices}}", "{{orderer}}", "{{peerservices}}", "{{explorerservices}}", "{{vizservices}}"],
    caservices: ["{{tlsca}}", "{{orgca}}"],
    peerservices: ["{{peer1}}", "{{peer2}}"],
    explorerservices: ["{{hlf_explorer_db}}", "{{hlf_explorer}}"],
    vizservices: ["{{swarm_visualizer}}", "{{portainer}}", "{{portainer_agent}}"],
  };
  ...
  useEffect(() => {
    if (currentUser) {
      axios
        .get(`https://articonf2.firebaseio.com/user_profile/${userUID}/IDs.json`)
        .then((res) => {
          if (res.data) {
      ...
      axios
        .get(`https://articonf2.firebaseio.com/user_profile/${userUID}/role.json`)
        .then((res) => {
  ...
  function getSmartTacTokens() {
    axios
      .get(`https://articonf2.firebaseio.com/user_profile/${userUID}/smart_token/token.json`)
      .then((res) => setSmartToken(res.data))
      .catch((err) => console.log(err.message));

    axios
      .get(`https://articonf2.firebaseio.com/user_profile/${userUID}/tac_token/token.json`)
  ...
  function topoBtnClick() {
    ...
    axios
      .get(`tosca_template/${id}`, requestOptions)
      .then((result) => {
  ...
  function planToscaBtn() {
    ...
    axios
      .get(`planner/plan/${id}`, requestOptions)
      .then((result) => {
        setPlannedToscaTemplate(result.data);
  ...
  function planTopoBtn() {
    ...
    axios
      .get(`tosca_template/${plannedToscaTemplate}`, requestOptions)
      .then((result) => {
  ...
  function provisionToscaBtn() {
    ...
    //${plannedToscaTemplate} => 5f60ad4e5695046700eed8bd
    axios
      .get(`provisioner/provision/${plannedToscaTemplate}`, requestOptions)
      .then((result) => {
        setProvisionToscaTemplate(result.data);
        setIsLoading(false);
      })
  ...
  function findProvisioned() {
    ...
    axios
      .get(`tosca_template/${provisionToscaTemplate}`, requestOptions)
      .then((result) => {
  ...
  function platformDeployer() {
    ...
    // ${provisionToscaTemplate} => 5f60ad9a5695046700eed8be
    axios
      .get(`deployer/deploy/${provisionToscaTemplate}`, requestOptions)
      .then((result) => {
      ...
      .catch((error) => {
        console.log("error", error);
        setMessage(
          "Ops something went wrong! Please contact our developers by pressing the 'Contact Us' botton bellow this message, sorry for the inconvenience!"
        );
        setDeploymentLoading(false);
        setIsTimeRemaining(false);
        alert(error);
  ...
  function findDeployed() {
    ...
    axios
      .get(`tosca_template/${deployedToscaId}`, requestOptions)
      .then((result) => {
  ...
  function deleteProvision() {
    ...
    axios
      .delete(`/tosca_template/${provisionToscaTemplate}`, requestOptions)
      .then((result) => {
  ...
  function findDeleted() {
    ...
    axios
      .get(`/tosca_template/${isDeleted}`, requestOptions)
      .then((result) => {
  ...
  function getAmountLayer() {
    ...
    smart
      .get("Amount_Layer/clusters", requestOptions)
      .then((reslut) => {
        setIsLoading(false);
