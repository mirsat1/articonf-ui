...
export default function UserProfileSetup(props) {
  ...
  return (
    <div>
      ...
      <Button onClick={props.toggle} floated="right" circular icon="close" color="red" />
      <br />
      <br />
      <div>
        <Segment>
        ...
        <Segment>
          <Header
            as="a"
            style={{ cursor: cursor, marginRight: "0.4em" }}
        ...
        >
          ...
          <Modal.Content scrolling>
            <Modal.Description>Change your email address</Modal.Description>
          ...
          <Modal.Actions>
            <Button content="OK" labelPosition="right" icon="checkmark" onClick={emailUpdate} positive />
            <Button content="Cancel" labelPosition="right" icon="cancel" onClick={() => setEmailOpen(false)} negative />
          </Modal.Actions>
        </Modal>
        <Modal
        ...
        >
          ...
          <Modal.Content scrolling>
            <Modal.Description>Change your password</Modal.Description>
          ...
          <Modal.Actions>
            <Button content="OK" labelPosition="right" icon="checkmark" onClick={changePassword} positive />
            <Button content="Cancel" labelPosition="right" icon="cancel" onClick={() => setPasswordOpen(false)} negative />
          </Modal.Actions>
        </Modal>
      </div>
    </div>
