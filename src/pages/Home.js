    ...
    return (
        <article className="theBody">
            ...
            <section className='text-section' title='homePageTextSection'>
                ...
                <h3>Welcome to ARTICONF and thank you for using our platform. If you want to deploy a distributed application (Token Bank Application) along with a blockchian network 
                    please go to <Link to="/beta/testing/deploy">deploy page</Link> and follow the instructions and steps presented there or watch our tutorial videos:<br />
                Part 1: <a href="https://youtu.be/2J_b4oVjWgs" target="_blank" rel="noopener noreferrer">Introduction to ARTICONF and deploying the sample application (using the CONF tool)</a><br />
