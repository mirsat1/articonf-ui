...
export default function Tac() {
  const { role, userUID, tacToken, smartToken, getSmartTacTokens } =
    useContext(Context);
          ...
          <select
            ...
            onChange={(e) => {
              setMappingBody({
                ...mappingBody,
                properties: {
                  ...mappingBody.properties,
                  [mappingFieldName]: { type: e.target.value },
                },
              });
            }}
          >
      ...
      content.push(
        <div>
          <input
            ...
            placeholder="Enter the name of the date field"
            required
          />
          <input
            style={{ marginBottom: "0.4em" }}
            onChange={(e) =>
              setDateFieldMappings({
                ...dateFieldMappings,
                properties: {
                  ...dateFieldMappings.properties,
                  [dateFieldName]: { type: "date", format: e.target.value },
                },
              })
            }
            placeholder="Enter the date field format"
            required
          />
        </div>
      );
  ...
  async function changeTacUser() {
    ...
    await app
      .database()
      .ref("user_profile/" + userUID + "/tac_token")
      .update({
  ...
  async function ingestSmartToTac() {
    ...
    try {
      ...
      if (response.data.length === 0) {
        setHasError({
          isError: true,
          errorMessage: "Recived empty object from smart!",
        });
        setIsLoading(false);
        onIngest("Failed");
        setTimeout(() => onIngest(""), 3000);
      ...
      const newArr = response.data.map((k) => {
        const oldObj = k;
        oldObj.location = {
          lat: k.geolocation_latitude,
          lon: k.geolocation_longitude,
        };
    ...
    <div className="theBody">
      ...
      >
        <Dropdown.Menu>
          ...
          <Dropdown.Divider />
          <Dropdown.Item
            onClick={toggleCreateUsser}
            icon="add user"
            text="Create new TAC user"
          />
          <Dropdown.Item
            onClick={toggleChangeUser}
            icon="refresh"
            text="Change TAC user"
          />
        </Dropdown.Menu>
      </Dropdown>
      <Divider />
        ...
        <Grid>
          <Grid.Column>
            <Segment style={{ height: "100%" }} raised>
              ...
              <br />
              <br />
              <Label color="red">Create new user</Label>
              <br />
              <br />
              <Form onSubmit={createTacUser}>
                ...
                <Form.Field>
                  <input
                    style={{ marginBottom: "0.4em" }}
                    onChange={(e) => setTacUserName(e.target.value)}
                ...
                <Form.Field>
                  <input
                    style={{ marginBottom: "0.4em" }}
                    onChange={(e) => setTacUserPassword(e.target.value)}
                    type="password"
                ...
                <Form.Field>
                  <input
                    style={{ marginBottom: "0.4em" }}
                    onChange={(e) => setTacUserEmail(e.target.value)}
                    type="email"
                    placeholder="Email"
                    required
                  />
                ...
                <Form.Field>
                  <input
                    style={{ marginBottom: "0.4em" }}
                    onChange={(e) => setTacUserFullName(e.target.value)}
                ...
                <Form.Field>
                  {role === "UCprovider" && (
                    <select
                      style={{ marginBottom: "0.4em" }}
                      onChange={(e) => setTacUserRole([e.target.value])}
                    >
              ...
              {tacCreateUser === "Failed" && (
                <Message color="red">
                  <Icon name="thumbs down outline" />
                  {tacCreateUser}
                </Message>
              )}
              {tacCreateUser === "Success" && (
        ...
        <Grid>
          <Grid.Column>
            <Segment style={{ height: "100%" }} raised>
              ...
              <br />
              <br />
              <Label color="red">Change TAC user</Label>
              <br />
              <br />
              ...
              {tacChangeUser === "Failed" && (
                <Message color="red">
                  <Icon name="thumbs down outline" />
                  {tacChangeUser}
                </Message>
              )}
              {tacChangeUser === "Success" && (
                <Message color="yellow">
                  <Icon name="thumbs up outline" />
                  {tacChangeUser}
                </Message>
      ...
      <Grid columns={2}>
        <Grid.Column>
          <Segment style={{ height: "100%" }} raised>
            ...
            <br />
            <br />
            <Label color="red">Create new index</Label>
            <br />
            <br />
            <Form onSubmit={createTacIndex}>
              <Form.Field>
                <input
                  ...
                  placeholder="Enter the name of the new index"
                  required
                />
              </Form.Field>
              {additionalSettings && (
                      ...
                      onChange={(e) =>
                        setCreateIndex({
                          ...
                          settings: {
                            ...
                            number_of_shards: e.target.value,
                          },
                        })
                      }
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setCreateIndex({
                          ...
                          settings: {
                            ...createIndex.settings,
                            number_of_replicas: e.target.value,
                          },
                        })
                      }
        ...
        <Grid.Column>
          <Segment style={{ height: "100%" }} raised>
            ...
            <br />
            <br />
            <Label color="red">Delete an index</Label>
            <br />
            <br />
      ...
      <Grid columns={2}>
        <Grid.Column>
          <Segment style={{ height: "100%" }} raised>
            ...
            <br />
            <br />
            <Label color="red">Setup mappings</Label>
            <br />
            <br />
            <Form onSubmit={putMappings}>
              <Form.Field>
                ...
                <input
                  style={{ marginBottom: "0.4em" }}
                  onChange={(e) => setNumOfFields(e.target.value)}
                  placeholder="Enter the how much fields you want to map"
                  type="number"
                  required
                />
        ...
        <Grid.Column>
          <Segment style={{ height: "100%" }} raised>
            ...
            <br />
            <br />
            <Label color="red">Setup date mappings</Label>
            <br />
            <br />
            <Form onSubmit={putDateMappings}>
              <Form.Field>
                ...
                <input
                  style={{ marginBottom: "0.4em" }}
                  onChange={(e) => setNumOfDateFields(e.target.value)}
                  placeholder="Enter the how much fields you want to map"
                  type="number"
                  required
                />
      ...
      <Segment style={{ height: "100%" }} raised>
        ...
        <br />
        <br />
        <Label color="red">Ingest data from SMART</Label>
        <br />
        <br />
        <Form onSubmit={ingestSmartToTac}>
          <Form.Field>
            <input
              style={{ marginBottom: "0.4em" }}
              onChange={(e) => setIndex(e.target.value)}
              placeholder="Enter the name of the index where the data you want to be ingested"
              required
            />
            <input
              style={{ marginBottom: "0.4em" }}
              ...
              <Grid.Column width={13}>
                ...
                {(numOfIngests || numOfFailIngests) !== 0 && (
                  <div>
                    <Message color="yellow">
                      <Icon name="thumbs up outline" />
                      Succeded: {numOfIngests}
                    </Message>
                    <Message color="red">
                      <Icon name="thumbs down outline" />
                      Failed: {numOfFailIngests}
                    </Message>
                    <Message>
                      <Icon name="info" />
                      If you change this tab, the proccess of ingestion will go
                      a lot slower!
                    </Message>
                  </div>
                )}
                <p>Documents to be ingested in TAC: {ingestLength}</p>
                <p>Ingested documents to TAC: {ingestedDocs}</p>
              </Grid.Column>
              <Grid.Column width={3}>
                <Button
                  floated="right"
