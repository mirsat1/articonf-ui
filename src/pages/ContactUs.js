...
export default function ContactUs() {
  ...
  function sendEmail(e) {
    ...
    setIsLoading(true);
    emailjs
      .sendForm("gmail", "contact_form", e.target, "user_ngGaDPIoYOmfyhxEzDTPE")
      .then(
        (result) => {
  ...
  return (
    <div className="theBody">
      <h1 style={{ textAlign: "center" }} title="contactUsTitle">
      ...
      <h1 style={{ textAlign: "center" }}>
        {status === "OK" &&
          "We recived your email. Thank you for your feedback!"}
      </h1>
      <h1 style={{ textAlign: "center" }}>{isLoading && "Sending..."}</h1>
      <h1 style={{ textAlign: "center" }}>
        {hasError && `We didn't recived you email\n ${errorMsg}`}
      </h1>
    </div>
  );
}
